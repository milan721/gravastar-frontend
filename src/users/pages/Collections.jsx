  ...
  return (
    <>
      ...
      {token && (
        <div className="px-5 md:px-10 py-10 flex gap-5">
          {/* Left Filters */}
          <div className="w-64 sticky top-24 flex flex-col gap-5 mt-15">
            {/* Genre */}
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-center mb-6 gap-3">
              <input
                ...
                className="max-w-xl w-full px-4 py-2 border rounded-full bg-white outline-none"
              />
              <button className="px-5 py-2 rounded-full bg-blue-600 text-white hover:bg-blue-700" onClick={handleSearch}>
                Search
              </button>
              <button onClick={resetAllFilters} className="px-4 py-2 border rounded-full bg-white text-gray-700 hover:bg-gray-100">
                Reset Filters
              </button>
            </div>
