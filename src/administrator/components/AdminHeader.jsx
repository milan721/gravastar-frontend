  ...
  {loggedIn ? (
    ...
    <Link to={'/login'}>
      ...
      <ul className={status? 'md:flex':'md:flex justify-center hidden'}>
        <Link to={'/admin-home'}><li className='mx-4 mt-3 md:mt-0'>Home</li></Link>
        <Link to={'/admin-collections'}><li className='mx-4 mt-3 md:mt-0'>Collections</li></Link>
        {/* <Link to={'/view'}><li className='mx-4 mt-3 md:mt-0'>View</li></Link> */}
        <Link to={'/admin-panel'}><li className='mx-4 mt-3 md:mt-0'>Admin Panel</li></Link>
      </ul>
    </nav>
